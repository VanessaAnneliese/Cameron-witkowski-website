...
export default function MyStoryPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      {/* Title — right-aligned, large, Space Mono */}
      <h1
        className="text-right font-bold mb-16"
        style={{ fontFamily: "var(--font-space-mono)", fontSize: "clamp(3rem, 10vw, 6rem)", lineHeight: 1.1 }}
      >
        My Story
      </h1>

      {/* Lead sentence — large monospace */}
      <p
        className="font-bold mb-10"
        style={{ fontFamily: "var(--font-space-mono)", fontSize: "clamp(1.25rem, 3vw, 1.6rem)", lineHeight: 1.6 }}
      >
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
        ...
        <p>
          ...
          logic devices all prime examples.
        </p>

        <div className="flex justify-center my-8">
          <Image
            src="/images/computer_construct.png"
            alt="Computer construct"
            width={500}
            height={380}
        ...
        <p>
          But where is this all going, and for what end do I ultimately aspire? The destination is
          nothing but the very source, and the end is just the beginning.
        </p>
