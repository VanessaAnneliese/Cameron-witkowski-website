      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <p className="font-semibold text-lg">Cameron S. Witkowski</p>
            <p className="text-gray-400 text-sm mt-1">
              <a href="mailto:cwitkowski@rogers.com" className="hover:text-[#1abc9c] transition-colors">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              aria-label="GitHub"
              className="text-gray-400 hover:text-[#1abc9c] transition-colors"
            >
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-500 text-xs">
          © 2023 CAMERON S. WITKOWSKI | ALL RIGHTS RESERVED
        </div>
      </div>
    </footer>
  );
